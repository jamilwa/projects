...
const options = [
  ...
  { key: 'Logout', text: (<Button id="btn-logout" className="ui animated button" style={{}} onClick={()=>onLogoutClicked()}><div className="visible content">Logout</div>
  <div className="hidden content">
  ...
  <ButtonGroup>
    ...
    <i className="user circle icon" style={{color: 'green'}}></i>{typeof window !== 'undefined'? localStorage.getItem('email') :null}</Button>
    <Dropdown
