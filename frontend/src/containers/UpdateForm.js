...
let obj = {
    ...
    return(
        ...
        <>
        <ComponentHeader />
            <form style={{border: '3px solid white', padding: '30px', marginBottom: '20px', backgroundColor: 'transparent'}}>
                <div className="row justify-content-center">
                    <div className="col-3 center-content">
                        ...
                        <label className="form-label" style={{color: 'white', fontSize: '15px'}}>Title</label>
                            <input type="text" style={{boxSizing: 'border-box', height: '39px', width: '426px', border: '1px solid white', borderRadius: '10px', backgroundColor: 'transparent', color: 'white'}} className="form-control" name="ideaTitle" placeholder="enter your title"
                                   value={ideaTitle}
                        ...
                        <label className="form-label" style={{color: 'white', fontSize: '15px'}}>Description</label>
                            <textarea type="text" style={{boxSizing: 'border-box', height: '80px', width: '100%', border: '1px solid white', borderRadius: '10px', backgroundColor: 'transparent', color: 'white'}} className="form-control" name="ideaDescription" placeholder="Description"
                        ...
                        <label className="form-label" style={{color: 'white', fontSize: '15px'}}>Story points</label>
                            <input type="number" className="form-control" style={{boxSizing: 'border-box', height: '39px', width: '426px', border: '1px solid white', borderRadius: '10px', backgroundColor: 'transparent', color: 'white'}} name="ideaStorypoints" placeholder="story points"
                        ...
                        className="ui animated button" style={{backgroundColor: 'transparent', border: '3px solid white', color: 'black'}} tableindex="0" onClick={() => onButtonHandler()}>
